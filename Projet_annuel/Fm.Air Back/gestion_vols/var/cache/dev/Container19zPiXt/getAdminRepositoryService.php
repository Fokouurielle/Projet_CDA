...
class getAdminRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\AdminRepository'])) {
            return $container->privates['App\\Repository\\AdminRepository'];
        }

        return $container->privates['App\\Repository\\AdminRepository'] = new \App\Repository\AdminRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);
    }
}
