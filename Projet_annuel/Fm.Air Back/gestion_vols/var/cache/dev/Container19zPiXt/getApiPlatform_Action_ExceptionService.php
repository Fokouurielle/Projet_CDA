...
class getApiPlatform_Action_ExceptionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['api_platform.action.exception'] = new \ApiPlatform\Action\ExceptionAction(($container->services['.container.private.serializer'] ?? self::get_Container_Private_SerializerService($container)), $container->parameters['api_platform.error_formats'], $container->parameters['api_platform.exception_to_status'], ($container->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? self::getApiPlatform_Metadata_Resource_MetadataFactory_CachedService($container)));
    }
}
