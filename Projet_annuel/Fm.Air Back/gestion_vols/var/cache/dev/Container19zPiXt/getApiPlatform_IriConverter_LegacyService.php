...
class getApiPlatform_IriConverter_LegacyService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->privates['debug.api_platform.item_data_provider'] ?? self::getDebug_ApiPlatform_ItemDataProviderService($container));

        if (isset($container->privates['api_platform.iri_converter.legacy'])) {
            return $container->privates['api_platform.iri_converter.legacy'];
        }
        $c = ($container->privates['debug.api_platform.subresource_data_provider'] ?? self::getDebug_ApiPlatform_SubresourceDataProviderService($container));

        if (isset($container->privates['api_platform.iri_converter.legacy'])) {
            return $container->privates['api_platform.iri_converter.legacy'];
        }
        $d = ($container->privates['api_platform.identifier.converter'] ?? self::getApiPlatform_Identifier_ConverterService($container));
