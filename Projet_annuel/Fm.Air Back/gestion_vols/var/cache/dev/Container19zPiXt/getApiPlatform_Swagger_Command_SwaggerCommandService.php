...
class getApiPlatform_Swagger_Command_SwaggerCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['api_platform.swagger.command.swagger_command'] = $instance = new \ApiPlatform\Core\Bridge\Symfony\Bundle\Command\SwaggerCommand(($container->services['.container.private.serializer'] ?? self::get_Container_Private_SerializerService($container)), ($container->privates['api_platform.metadata.resource.name_collection_factory.cached'] ?? self::getApiPlatform_Metadata_Resource_NameCollectionFactory_CachedService($container)), '', '', '0.0.0', NULL, $container->parameters['api_platform.swagger.versions'], true);
