...
class __TwigTemplate_307c4ca46c106b5437ac05a179835da1 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        echo "\" name=\"email\" id=\"inputEmail\" class=\"form-input\" autocomplete=\"email\" required autofocus>
                ...
                <input type=\"password\" class=\"form-input\" name=\"password\" id=\"inputPassword\" class=\"form-control\" autocomplete=\"current-password\" required>
                </div>
...
";
    ...
    {
        return array (  140 => 42,  136 => 31,  125 => 23,  119 => 19,  114 => 16,  110 => 15,  107 => 14,  105 => 13,  102 => 12,  96 => 10,  94 => 9,  88 => 5,  78 => 4,  59 => 3,  36 => 1,);
    }
    ...
    <div class=\"row\">
        <div class=\"col\">
            <form class=\"form\" method=\"post\">
                ...
                {% if app.user %}
                    <div class=\"mb-3\">
                        Vous êtes connecté(e) en tant que  {{ app.user.userIdentifier }}, <a href=\"{{ path
                        ('app_logout') }}\">Se déconnecter</a>
                    </div>
                {% endif %}
                ...
                <div class=\"form-container\">
                <label class=\"form-label\" for=\"inputEmail\">Email</label>
                <input type=\"email\" class=\"form-control\" value=\"{{ last_username }}\" name=\"email\" id=\"inputEmail\" class=\"form-input\" autocomplete=\"email\" required autofocus>
                </div>
                <br> <br>
                <div class=\"form-container\">
                <label class=\"form-label\" for=\"inputPassword\">Mot de passe</label>
...
{% endblock %}
", "security/login.html.twig", "C:\\wamp64\\www\\Projet_annuel\\gestion_vols\\templates\\security\\login.html.twig");
    }
}
